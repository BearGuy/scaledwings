    ...
    <div className="flex flex-col md:h-screen w-full p-5 md:py-10 md:px-5">
        ...
        }
        {
          <div className={`${!show_mobile_dropdown ? `hidden` : `visible`} fixed w-full bg-raisinblack left-0 z-10`}>
            <ul>
              ...
              <Link href="/booking"><li className={`text-white text-md mb-2.5 underline text-center hover:text-lavenderblue cursor-pointer p-2`} style={{ textDecorationColor: `#CCCFFF`, textDecorationStyle: `wavy`, fontSize: 20 }}>Booking</li></Link>
            </ul>
          </div>
        }
      ...
      <div className="hidden md:visible md:inline-block mt-10">
        <ul>
          ...
          <Link href="/booking"><li className={`text-white text-md mb-2.5 underline text-center hover:text-lavenderblue cursor-pointer`} style={{ textDecorationColor: `#CCCFFF`, textDecorationStyle: `wavy`, fontSize: 20 }}>Booking</li></Link>
        </ul>
